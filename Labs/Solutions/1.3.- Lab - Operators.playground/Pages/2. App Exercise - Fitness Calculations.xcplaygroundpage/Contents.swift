...
print(averageHRD.rounded(FloatingPointRoundingRule.up))
print(averageHRD.rounded(.down))
...
// swift
func send(message: String, to person: String? = nil) {
  print("Sending message: \(message) to \(person)")
}
