 ...
 */
print("You cannot change the value of friends because it was declared as a constant. Trying to change its value after it was originally assigned will result in a compile error.")
