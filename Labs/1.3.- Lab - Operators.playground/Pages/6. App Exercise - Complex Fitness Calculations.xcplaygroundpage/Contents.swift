 ...
 */
let heartRate1: Double = 65, heartRate2: Double = 85, heartRate3: Double = 95
let avgHeartRate: Double = (heartRate1 + heartRate2 + heartRate3) / 3
print(avgHeartRate)
/*:
...
let tempCelsius: Double = (tempInFahrenheit - 32) * (5.0/9.0)
print(tempCelsius)
