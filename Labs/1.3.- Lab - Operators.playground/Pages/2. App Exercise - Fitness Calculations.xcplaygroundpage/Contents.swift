 ...
 */
let heartRate1: Int = 65, heartRate2: Int = 85, heartRate3: Int = 95
 ...
 */
let heartRate1D: Double = Double(heartRate1), heartRate2D: Double = Double(heartRate2), heartRate3D: Double = Double(heartRate3)
 ...
 */
let steps: Double = 3_467, goal: Double = 10_000
