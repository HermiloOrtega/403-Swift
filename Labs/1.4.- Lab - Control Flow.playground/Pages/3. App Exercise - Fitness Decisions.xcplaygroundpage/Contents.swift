 ...
 */
var steps: Int = 12_492
let stepGoal = 10_000
print(steps<(stepGoal/2) ? "You're almost halfway there!" : "You're over halfway there!")
/*:
...
// TERNARY OPERATOR
    print(steps<(stepGoal/10) ? "Way to get a good start today!" : steps<(stepGoal/2) ? "You're almost halfway there!" : "You're over halfway there!")
