...
let hasPizza = false
let hasVegan = true
print((hasFish == true || hasPizza == true) && hasVegan == true ? "Let's go!" : "Sorry, we'll have to think of somewhere else")
/*:
...
let isRaining = true
let isSunny = true
let isNiceWeather: Bool = isRaining == false || temp >= temp ? true : false
print(isNiceWeather ? "I'm going for a walk!" : "Not today")
